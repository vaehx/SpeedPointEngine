...
namespace SpeedPoint
{
	...
	// The sections are there to minimize code in the SRenderPipeline implementation classes.
	// There are some implementations like SDirectX9GeometryRenderSection, ~LightingRenderSection, ~PostRenderSection
	class S_API SRenderPipelineSection
	{	
	public:
		// Initialize the Render Pipeline State
		virtual SResult Initialize(SpeedPointEngine* pEngine, SRenderPipeline* pRenderPipeline) = 0;
