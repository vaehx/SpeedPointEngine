...
// ------------------------------------------------------------------------------
// Component only stores data required for rendering.
// It does not hold a Render() function.
struct IRenderableObjectComponent 
{
	virtual Geometry* GetGeometry() = 0;
	virtual Material** GetMaterials() = 0;       
};
// impl:
class RenderableObjectComponent : public IRenderableObjectComponent
{
private:
	Geometry geometry;
	Material** pMaterials;
