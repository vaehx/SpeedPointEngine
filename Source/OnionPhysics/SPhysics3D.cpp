...
namespace SpeedPoint
{
	...
	S_API bool SPhysics3D::SphereSphere( OSphere* pSphere1, OSphere* pSphere2, float3* pvDistance, OPoint* ppCollision, float* pfIntCircleRad )
	{
	...
	S_API bool SPhysics3D::SphereBox( OSphere* pSphere, OBox* pBox, float3* pvDistance, short* nPlanesColliding, float3* pvNormalAverage )
	{
	...
	S_API bool SPhysics3D::SphereCapsule( OSphere* pSphere, OCapsule* pCapsule, float3* pvDistance, short* pnSphere )
	{
	...
	S_API bool SPhysics3D::SphereLine( OSphere* pSphere, OLine* pLine, float3* pvDistance, float* pS, float3* pvIntPnt1, float3* pvIntPnt2 )
	{
	...
	S_API bool SPhysics3D::SpherePlane( OSphere* pSphere, OPlane* pPlane, float3* pvDistance, float3* pvIntCircleCenter, float* pfIntCircleRad )
	{
	...
	S_API bool SPhysics3D::SphereCylinder( OSphere* pSphere, OCylinder* pCyl, float3* pvDistance, short* piPlane )
	{
	...
	S_API bool SPhysics3D::SpherePoint( OSphere* pSphere, OPoint* pPoint, float3* pvDistance )
	{
	...
	S_API bool SPhysics3D::BoxBox( OBox* pBox1, OBox* pBox2, float3* pvDistance, short* nPlanesColliding, float3* pvNormalAverage )
	{
		return false;
	}
	...
	S_API bool SPhysics3D::BoxCapsule( OBox* pBox, OCapsule* pCapsule, float3* pvDistance, short* pnPlanesColliding, float3* pvNormalAverage, short* pnSphere )
	{
		return false;
	}
	...
	S_API bool SPhysics3D::BoxLine( OBox* pBox, OLine* pLine, float3* pvDistance, short* pnPlanesColliding, float3* pvNormalAverage, float3* pvIntPnt1, float3* pvIntPnt2 )
	{
		return false;
	}
	...
	S_API bool SPhysics3D::BoxPlane( OBox* pBox, OPlane* pPlane, float3* pvDistance, short* pnPlanesColliding, float3* pvNormalAverage )
	{
		return false;
	}
	...
	S_API bool SPhysics3D::BoxCylinder( OBox* pBox, OCylinder* pCyl, float3* pvDistance, short* pnPlanesColliding, float3* pvNormalAverage, short* pnCylPlane )
	{
		return false;
	}
	...
	S_API bool SPhysics3D::BoxPoint( OBox* pSphere, OPoint* pPoint, float3* pvDistance )
	{
		return false;
	}
	...
	S_API bool SPhysics3D::CapsuleCapsule( OCapsule* pCapsule1, OCapsule* pCapsule2, float3* pvDistance, short* pnSphere1, short* pnSphere2 )
	{
	...
	S_API bool SPhysics3D::CapsuleLine( OCapsule* pCaps, OLine* pLine, float3* pvDistance, short* pnSphere, bool* pbParallel )
	{
		return false;
	}
	...
	S_API bool SPhysics3D::CapsulePlane( OCapsule* pCaps, OPlane* pPlane, float3* pvDistance, bool* pbParallel, short* pnSphere )
	{
		return false;
	}
	...
	S_API bool SPhysics3D::CapsuleCylinder( OCapsule* pCaps, OCylinder* pCyl, float3* pvDistance, bool* pbParallel, short* pnSphere, short* pnCylPlane )
	{
		return false;
	}
	...
	S_API bool SPhysics3D::CapsulePoint( OCapsule* pCaps, OPoint* pPoint, float3* pvDistance )
	{
		return false;
	}
	...
	S_API bool SPhysics3D::LineLine( OLine* pLine1, OLine* pLine2, float3* pvDistance, bool* pbParallel, float3* pvIntPnt, float* pS1, float* pS2 )
	{
	...
	S_API bool SPhysics3D::LinePlane( OLine* pLine, OPlane* pPlane, float3* pvIntPnt, float* pS, float3* pvDistance, bool* pbParallel )
	{
		return false;
	}
	...
	S_API bool SPhysics3D::LineCylinder( OLine* pLine, OCylinder* pCyl, float3* pvDistance, short* pnPlane, bool* pbParallel )
	{
		return false;
	}
	...
	S_API bool SPhysics3D::LinePoint( OLine* pLine, OPoint* pPoint, float3* pvDistance )
	{
	...
	S_API bool SPhysics3D::PlanePlane( OPlane* pPlane1, OPlane* pPlane2, float3* pvDistance, OLine* pIntLine, bool* pbParallel )
	{
	...
	S_API bool SPhysics3D::PlaneCylinder( OPlane* pPlane, OCylinder* pCyl, float3* pvDistance, short* pnSphere )
	{
		return false;
	}
	...
	S_API bool SPhysics3D::PlanePoint( OPlane* pPlane, OPoint* pPoint, float3* pvDistance )
	{
	...
	S_API bool SPhysics3D::CylinderCylinder( OCylinder* pCyl1, OCylinder* pCyl2, float3* pvDistance, short* piPlane1, short* piPlane2 )
	{
		return false;
	}
	...
	S_API bool SPhysics3D::CylinderPoint( OCylinder* pCyl, OPoint* pPoint, float3* pvDistance )
	{
		return false;
	}
	...
	S_API bool SPhysics3D::PointPoint( OPoint* pPoint1, OPoint* pPoint2, float3* pvDistance )
	{
