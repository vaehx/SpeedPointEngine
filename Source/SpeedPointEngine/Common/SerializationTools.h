...
#define DeserializeVector DeserializeVec3f
	...
	// Stores the attributes in a map of strings
	class S_API CBasicSerContainer : public ISerContainer
	{
	private:
		vector<CBasicSerContainer> m_Children;
		vector<ISerContainer*> m_ChildPointers;
		map<string, string> m_Attributes;

	public:
		CBasicSerContainer(const string& name);
