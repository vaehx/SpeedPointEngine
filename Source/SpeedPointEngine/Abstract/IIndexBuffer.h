...
public:
	...
	virtual SResult Initialize(IRenderer* pRenderer, EIBUsage usage, S_INDEXBUFFER_FORMAT format, const void* pInitialData = nullptr, unsigned long nInitialIndices = 0) = 0;
	virtual SResult Initialize(IRenderer* pRenderer, EIBUsage usage, const SIndex* pInitialData = nullptr, unsigned long nInitialIndices = 0) = 0;
